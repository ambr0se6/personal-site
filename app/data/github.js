...
const data = [
  {
    ...
    key: 'forks',
    value: '0',
    link: 'https://github.com/ambr0se6/personal-site/network',
  }, {
    ...
    value: '0',
    link: 'https://github.com/ambr0se6/personal-site/issues',
  }, {
    label: 'Last updated at',
    key: 'pushed_at',
    value: dayjs().format('MMMM D, YYYY'),
    link: 'https://github.com/ambr0se6/personal-site/commits',
  },
  { /* find . | grep ".js" | grep -vE ".min.js|node_modules|.git|.json" |
    xargs -I file cat file | wc -l */
    label: 'Lines of Javascript powering this website',
    value: '2625',
    link: 'https://github.com/ambr0se6/personal-site/graphs/contributors',
  },
];
